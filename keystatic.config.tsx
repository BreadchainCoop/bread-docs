...
export default config({
  ...
  ui: { 
    brand: { 
      name: 'Breaditor',
      mark: ({ colorScheme }) => {
        const fill = colorScheme === 'dark' ? '#F6F3EB' : '#F6F3EB';
        return (
          <svg 
            width="24" 
            height="24" 
