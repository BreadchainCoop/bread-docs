...
You'll need a wallet connected to the [Solidarity Fund app](https://fund.bread.coop/). If you haven't connected yet, see [Connecting a Wallet](/tools/solidarity-fund/connecting-a-wallet/).

---

## Baking BREAD

Baking deposits xDAI into the Solidarity Fund and mints an equal amount of BREAD in return. The rate is always 1:1. Your deposit generates yield for the network, but the deposit itself stays yours. (You'll need some xDAI in your connected wallet.)
...
Burning redeems your BREAD back to xDAI at a 1:1 ratio. There is no penalty, no waiting period, and no minimum amount. (You'll need BREAD in your connected wallet.)
