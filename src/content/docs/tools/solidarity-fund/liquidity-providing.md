...
description: "How to provide liquidity for BREAD on a DeFi market without losing your voting power in the monthly distribution."
sidebar:
  order: 2
---
...
Your voting power is still calculated the same way — as an average over the previous month, with a one-month delay. See [How it Works](/tools/solidarity-fund/how-it-works/#understanding-voting-power) for the details.
...
2. **Stake your LP tokens** — deposit them into the vault at [app.breadchain.xyz/governance/lp-vaults](https://app.breadchain.xyz/governance/lp-vaults)
...
A complete walkthrough, with screenshots: [Adding Liquidity to Breadchain — A Complete Guide](https://paragraph.com/@breadchain-cooperative/adding-liquidity-to-breadchain-a-complete-guide)
