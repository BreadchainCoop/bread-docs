---
title: How Stacks works
description: "Bread Stacks puts savings circles on-chain — group-set rules, tamper-proof escrow, and automatic distributions."
sidebar:
  order: 1
---

Savings circles for those closest to you, running on infrastructure that doesn't depend on geography, a company, or a bank.
...
Members pool $BREAD at regular intervals. Each round, one member receives the full pool. The rotation continues until everyone has had their turn. The same format that has worked for centuries — see [What is a savings circle?](/tools/stacks/what-is-a-savings-circle/) — without the failure modes that come from one person, or one company, holding the money.
