...
The Bread Core Team team includes the developers and designers of Bread Cooperative applications as well as the stewards of the online community. The Bread Core Team team builds Solidarity Primitives - development tools which help to forge solidarity between individuals and collectives. The first solidarity primitive created by the Bread Cooperative is the [$BREAD Token](/token/) found on the [Bread Crowdstaking Application](https://app.breadchain.xyz/) built on top of Gnosis Chain.
...
<Card title="Crypto Leftists Community">
